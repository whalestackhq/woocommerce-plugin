...
class WS_Merchant_Client extends WS_Rest_Client {
    ...
    private function fetchTimestamp() {
        ...
        $timestamp = time();
        $client = new WS_REST_Client('https', 'www.whalestack.com', '/api/v1');
    ...
    private function log($message) {
        ...
        WS_Logging_Service::write($message);
